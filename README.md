# voyra-ai-compare · AI 模型对比秀

> Voyra 个人网站（https://lxlrwxs.top）的「AI 模型对比秀」模块源码。
> 本仓库为唯一源码来源，push 后通过 GitHub Actions 自动同步至 Voyra 主仓库并触发部署。

## 目录说明

```
src/pages/PelicanGallery.jsx
```
...
AI 模型对比秀、ai、comparison、showcase、models、react、svg、react、vite
